...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
     ...
     */
    @Autowired
    public void configureGlobal(final AuthenticationManagerBuilder auth, JdbcTemplate jdbc, UsersService users)
            throws Exception { // NOPMD

        auth.authenticationProvider(new IfwAuthenticationProvider(jdbc, users));
